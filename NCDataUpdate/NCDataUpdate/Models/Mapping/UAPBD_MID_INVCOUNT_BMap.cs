...
{
    public class UAPBD_MID_INVCOUNT_BMap : EntityTypeConfiguration<UAPBD_MID_INVCOUNT_B>
    {
        public UAPBD_MID_INVCOUNT_BMap()
        {
            // Primary Key
            ...
            this.ToTable("UAPBD_MID_INVCOUNT_B", "DI");
            ...
            this.Property(t => t.COUNTNUM).HasColumnName("COUNTNUM");
            this.Property(t => t.ONHANDNUM).HasColumnName("ONHANDNUM");
