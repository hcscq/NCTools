...
{
    public class UAPBD_MID_DISCARDOUT_BMap : EntityTypeConfiguration<UAPBD_MID_DISCARDOUT_B>
    {
        public UAPBD_MID_DISCARDOUT_BMap()
        {
            // Primary Key
            ...
            this.Property(t => t.WASTEWAREHOUSE)
                .HasMaxLength(50);
            ...
            this.ToTable("UAPBD_MID_DISCARDOUT_B", "DI");
            ...
            this.Property(t => t.WASTEWAREHOUSE).HasColumnName("WASTEWAREHOUSE");
