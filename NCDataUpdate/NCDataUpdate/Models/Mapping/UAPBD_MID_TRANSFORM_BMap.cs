...
{
    public class UAPBD_MID_TRANSFORM_BMap : EntityTypeConfiguration<UAPBD_MID_TRANSFORM_B>
    {
        public UAPBD_MID_TRANSFORM_BMap()
        {
            // Primary Key
            ...
            this.Property(t => t.SRCMATERIAL)
                .HasMaxLength(100);

            this.Property(t => t.SRCMARUNIT)
                .HasMaxLength(50);
            ...
            this.ToTable("UAPBD_MID_TRANSFORM_B", "DI");
            ...
            this.Property(t => t.SRCMATERIAL).HasColumnName("SRCMATERIAL");
            this.Property(t => t.SRCMARUNIT).HasColumnName("SRCMARUNIT");
            this.Property(t => t.SRCNUM).HasColumnName("SRCNUM");
