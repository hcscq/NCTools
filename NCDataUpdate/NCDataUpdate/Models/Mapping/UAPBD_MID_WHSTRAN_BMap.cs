...
{
    public class UAPBD_MID_WHSTRAN_BMap : EntityTypeConfiguration<UAPBD_MID_WHSTRAN_B>
    {
        public UAPBD_MID_WHSTRAN_BMap()
        {
            // Primary Key
            ...
            this.Property(t => t.SHLDDILIVERDATE)
                .HasMaxLength(19);

            this.Property(t => t.OTHERWH)
                .HasMaxLength(50);

            this.Property(t => t.SHLDARRIVEDATE)
                .HasMaxLength(19);
            ...
            this.ToTable("UAPBD_MID_WHSTRAN_B", "DI");
            ...
            this.Property(t => t.SHLDDILIVERDATE).HasColumnName("SHLDDILIVERDATE");
            this.Property(t => t.OTHERWH).HasColumnName("OTHERWH");
            this.Property(t => t.SHLDARRIVEDATE).HasColumnName("SHLDARRIVEDATE");
